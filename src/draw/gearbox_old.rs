use std::{error::Error, fs::File, io::BufReader, path};

use plotters::{coord::Shift, prelude::*};
use tracing::info;

use crate::{analysis::analyze_gearbox, cli::ExecResult};

use super::{draw_data, DrawFn};

/// draw gearbox cycle distribution
pub fn draw_gearbox_old(gearbox_args: ExecResult) -> eyre::Result<()> {
    let ExecResult {
        result_file,
        output,
    } = gearbox_args;
